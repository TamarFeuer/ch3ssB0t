...
class Queen : Piece
{
	public Queen(Vector2 posInWorld, bool color)
	{
		this.posInWorld = posInWorld;
		this.color = color;

		if (color)
			texture = Raylib.LoadTexture("./Textures/Pieces/White/Queen_White.png");
		else
			texture = Raylib.LoadTexture("./Textures/Pieces/Black/Queen_Black.png");
	}
