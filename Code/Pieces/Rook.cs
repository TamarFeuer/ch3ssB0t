...
class Rook : Piece
{
	public Rook(Vector2 posInWorld, bool color)
	{
		this.posInWorld = posInWorld;
		this.color = color;

		if (color)
			texture = Raylib.LoadTexture("./Textures/Pieces/White/Rook_White.png");
		else
			texture = Raylib.LoadTexture("./Textures/Pieces/Black/Rook_Black.png");
	}
